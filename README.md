...
This app was made as to the fulfilment of the Milestone Project 3 for the Full-Stack Software Development Course provided by Code Institute. It was made using Python and deployed on Heroku using Code Institue's mock terminal.
...
The Restaurant Management App is designed to improve efficiency, reduce errors and be an easy way for all restaurant managers to create bookings, view bookings and calculate the minimum number of staff needed for each working day.

The user has three options upon opening the app:

1. Enter a new booking
2. View total number of bookings
3. Calculate staff numbers required for the upcoming week

The user selects their desired option and follows the on-screen instructions. Depending on their choice they will be shown an output with their desired data.
...
- As a user I want to be able:
    ...
    - To make a booking for a specific day and input the number of guests required for the booking.
...
- An initial flow chart was sketched out at the conception of this project.
...
- As the app is run using Code Institue's Mock Terminal it doesn't offer a particularly user-friendly interface. This could be improved by adapting the terminal or creating original HTML/CSS code for the app, turning it into a Full Stack Project.  
...
Please be aware that if you wish to use this repository for your own business or with your own historical data, you must use the following steps in addition to the above:
